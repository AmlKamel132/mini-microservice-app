...
app.post("/events", (req, res) => {
  ...
  axios.post("http://posts-clusterip-srv:4000/events", event).catch((err) => { // post-service
    
    console.log(err.message);
  });

  
  axios.post("http://comments-clusterip-srv:4001/events", event).catch((err) => {  // comment-service
